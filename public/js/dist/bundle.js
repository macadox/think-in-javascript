...
},{}],"files/searchPosts.js":[function(require,module,exports) {
"use strict";
...
var searchPosts = function searchPosts(e) {
  e.preventDefault();

  var query = _dompurify.default.sanitize(e.target.search.value);

  window.location.assign("/search?q=".concat(query));
};
